...
document.getElementById('bee').onmousedown = function () {
  ...
  sound2.src =
    'https://github.com/AaronNewTech/Aarons-glorious-website/blob/main/audio/Galaga_Kill_Enemy_Sound_Effect2.mp3?raw=true';
  function play() {
    sound2.play();
  }
  setTimeout(play, 500);
...
document.body.onkeyup = function (e) {
  if (e.keyCode == 32) {
    ...
    shoot1.src =
      'https://github.com/AaronNewTech/Aarons-glorious-website/blob/main/audio/Galaga_Firing_Sound_Effect2.mp3?raw=true';
    shoot1.play();
  }
};
